// =====================================================
// ÉVÉNEMENTS
// Ce fichier alimente automatiquement :
// - la liste d'événements sur la page d'accueil,
// - la page /evenements.html,
// - les liens vers les galeries,
// - les images et textes principaux des événements.
//
// AJOUTER UN ÉVÉNEMENT :
// 1. Placer ses images dans /uploads/
// 2. Copier-coller un bloc événement existant.
// 3. Modifier slug, title, number, images, meta, descriptions et liens.
// 4. showOnHome: true => apparaît sur la home.
// 5. showOnEventsPage: true => apparaît sur la page Événements.
//
// MASQUER TEMPORAIREMENT :
// - showOnHome: false pour le masquer de l'accueil.
// - showOnEventsPage: false pour le masquer de la page événements.
//
// LIENS :
// - ticketUrl vide => pas de bouton billetterie spécifique.
// - googlePhotosUrl vide => pas de bouton Google Photos spécifique.
// - galleryPage vide => pas de lien galerie.
//
...
// -----------------------------------------------------
// GUIDE DES CHAMPS D'UN ÉVÉNEMENT
// Exemple fictif non utilisé par le site :
// {
//   slug: "wei",                    // Identifiant unique. Sert aussi d'ancre dans evenements.html#wei. Ne pas mettre d'espace ni d'accent.
//   order: 3,                        // Ordre d'affichage. Plus le chiffre est petit, plus l'événement apparaît haut.
//   number: "03",                    // Numéro décoratif affiché sur les cartes et sections.
//   title: "WEI",                    // Nom visible de l'événement.
//   subtitle: "Week-end...",         // Sous-titre descriptif, utile pour certaines pages/sections.
//   category: "Début d'année",       // Catégorie générale.
//   date: "2026-09-18",              // Date technique au format YYYY-MM-DD. Laisser "" si inconnue.
//   dateLabel: { fr: "18 septembre 2026", en: "September 18, 2026" }, // Date affichée si vous voulez contrôler le texte exact.
//   statusLabel: { fr: "En vente", en: "On sale" }, // Statut prioritaire : À venir, Passé, En vente, Complet, etc.
//   statusColor: "red",              // Couleur spéciale du statut sur la home. "red" force le rouge, "" garde le style normal.
//   showStatusWithDate: true,         // Optionnel. Si true, affiche statut + date ensemble, ex. "En vente · 18 septembre 2026".
//   place: "Paris",                  // Ville ou zone générale.
//   venue: "Lieu exact",             // Lieu précis si connu. Laisser "" si non défini.
//   shortDescription: "Texte court", // Description courte de secours.
//   homeDescriptionI18n: { fr: "...", en: "..." }, // Description courte FR/EN utilisée sur la homepage.
//   homePeriod: "Septembre",         // Période affichée en secours.
//   homePeriodI18n: { fr: "Septembre", en: "September" }, // Période FR/EN sur la homepage.
//   longDescription: ["..."] ,       // Ancien format de description longue. Conservé pour compatibilité.
//   descriptionBlocks: [              // Paragraphes affichés sur la page événements.
//     { text: "Texte FR", i18n: { fr: "Texte FR", en: "English text" } }
//   ],
//   image: "uploads/photo.jpg",      // Image principale de l'événement.
//   images: ["uploads/photo.jpg"],    // Images de la galerie courte dans la section événement.
//   alt: "Description image",        // Texte alternatif de l'image pour accessibilité/SEO.
//   ticketUrl: "",                   // Lien billetterie. Vide = pas de lien spécifique.
//   ticketLabel: "Réserver",         // Texte du bouton/lien billetterie si le rendu l'utilise.
//   dossierUrl: "uploads/dossier-wei.pdf", // Fichier ou lien vers le dossier à remplir. Vide = rien n'apparaît.
//   dossierLabel: { fr: "Dossier à remplir", en: "Form to complete" }, // Texte du lien dossier.
//   dossierDownload: true,            // true = demande le téléchargement quand le fichier est local. false = ouvre comme lien normal.
//   googlePhotosUrl: "",             // Lien album Google Photos si utilisé.
//   galleryPage: "galerie-wei.html", // Page galerie interne. Vide = pas de lien galerie.
//   galleryLabel: "Galerie photos des éditions →", // Texte du lien galerie.
//   showOnHome: true,                 // true = apparaît sur la homepage.
//   showOnEventsPage: true,           // true = apparaît sur evenements.html.
//   showOnNuitsPage: false,           // true = peut être utilisé par la page Nuits si le rendu le prévoit.
//   featured: false,                  // Marqueur de mise en avant éventuelle.
//   status: "current",               // Statut interne ancien/conservé. Ne pas confondre avec statusLabel.
//   tags: [                           // Étiquettes affichées dans la section événement.
//     { label: "Début d'année", red: false, i18n: { fr: "Début d'année", en: "Start of year" } }
//   ],
//   meta: [                           // Petites lignes d'information : format, période, objectif, ambiance, etc.
//     { key: "Format", value: "Week-end", keyI18n: { fr: "Format", en: "Format" }, valueI18n: { fr: "Week-end", en: "Weekend" } }
//   ],
//   artists: [],                      // Liste d'artistes liés à l'événement, si nécessaire.
//   reverse: false                    // true inverse image/texte sur desktop pour alterner la mise en page.
// }
