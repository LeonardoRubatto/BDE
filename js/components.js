...
(function(){
  ...
  window.BDEComponents = {
    ...
    footer(){
      ...
      </div><div class="footer-bottom"><span class="footer-copy">${esc((s.copyrightText||'').replace(String(s.year), String(s.year)))}</span><div class="footer-bottom-right"><a href="https://telaventis.fr" target="_blank" rel="noopener" class="footer-legal-link">Site by Telaventis</a><a href="mentions-legales.html" class="footer-legal-link" data-fr="Mentions légales" data-en="Legal Notice">Mentions légales</a><div class="footer-socials"><a href="${esc(s.instagramUrl)}" target="_blank">Instagram</a><a href="${esc(s.tiktokUrl)}" target="_blank">TikTok</a><a href="${esc(s.facebookUrl)}" target="_blank">Facebook</a></div></div></div></div>`;
    },
    ticketModal(){
